#' Calculate a total from a survey
#'
...
#' create_analysis_total(me_design, analysis_var = "aa")
#' create_analysis_total(me_design, group_var = "bb", analysis_var = "aa")
#'
#' me_design_w <- srvyr::as_survey(somedata, weights = weights)
#' create_analysis_total(me_design_w, analysis_var = "aa")
#' create_analysis_total(me_design_w, group_var = "bb", analysis_var = "aa")
#'
create_analysis_total <- function(design, group_var = NA, analysis_var, level = .95) {
